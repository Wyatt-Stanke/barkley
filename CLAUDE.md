...
- **The page around the game is a SolidJS app (2026-09-25, part of the undeployed v1.4.0).** `src/web` became a Vite +
...
- **v1.4.0 (`src/version.json`; not built or deployed yet): a browser tab no longer downloads the offline copy by
  ...
  which then completes; `?nosw` shows the version alone. Not seen yet on a real build or a real device.
